...
<div class="elem"><img class= "imgs" src="${imageurl + poster_path}" alt=""> <h2 class = "titulospelis">${title}</h2> </div>` 
...
function showTV(data) {
    mainn.innerHTML = ""; 
    data.forEach((tv)=>{const {name, poster_path} = tv
const element2 = document.createElement("div")
element2.innerHTML = `<div class="elem"><img class= "imgs" src="${imageurl + poster_path}" alt=""> <h2 class = "titulospelis">${name}</h2> </div>` 
